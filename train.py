...
parser = argparse.ArgumentParser(description='Train a clean/watermarked model')
...
parser.add_argument('--lradj', default=20, type=int, help='multiple the lr by args.ratio every args.lradj epochs')
...
if args.resume:
    ...
    elif args.model == 'resnet18_basic':
        net = ResNet18_Basic(num_classes=n_classes)
    elif args.model == 'vgg16_bn':
        net = vgg16_bn(num_classes=n_classes)
    elif args.model == 'resnet18_EW':
        net = resnet_EW.ResNet18(num_classes = n_classes)
